        ...
        .state('attend', {
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'MetronicApp',
                        insertBefore: '#ng_load_plugins_after', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            '/assets/pages/css/append.css',
                            ...
                            // '/assets/pages/scripts/ui-tree.js',
                            '/js/controllers/attend.js'
                        ]
                    });
                }]
            }
